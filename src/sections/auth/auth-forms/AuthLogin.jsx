...
export default function AuthLogin({ isDemo = false }) {
  ...
  const handleGoogleLoginSuccess = async (response) => {
    ...
    try {
      const apiResponse = await fetch(`${import.meta.env.VITE_APP_API_URL}auth/google/callback`, {
        method: 'POST',
      ...
      if (data.status) {
        ...
        localStorage.setItem('user', JSON.stringify(data.response)); // Store user info
